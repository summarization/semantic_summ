...
from fei.eval.pyrouge.utils import log
from fei.eval.pyrouge.utils.file_utils import DirectoryProcessor
...
class Rouge155(object):
    ...
    def split_sentences(self):
        ...
        """
        from fei.eval.pyrouge.utils.sentence_splitter import PunktSentenceSplitter
...
if __name__ == "__main__":
    ...
    rouge_dir = '/Users/feiliu/Softwares/ROUGE/RELEASE-1.5.5'
    rouge_args = '-e /Users/feiliu/Softwares/ROUGE/RELEASE-1.5.5/data -n 4 -m -2 4 -u -c 95 -r 1000 -f A -p 0.5 -t 0 -a -x -l 100'
     
    rouge = Rouge155(rouge_dir, rouge_args)
    
#     rouge.model_dir = '/Users/feiliu/Data/SemanticSumm/TAC_Fei/2008/models'
#     rouge.model_filename_pattern = 'D08#ID#-A.M.100.[A-Z].[A-Z]'
    
    rouge.model_dir = '/Users/feiliu/Data/SemanticSumm/Dani_Summ/model_summary'
    rouge.model_filename_pattern = 'D08#ID#[A-Z].summ.gold.[0-9].body.tok'
    
    rouge.system_dir = '/Users/feiliu/Data/SemanticSumm/Dani_Summ/coverage_summary'
    rouge.system_filename_pattern = 'D08(\d+)[A-Z].summ.guess.coverage.body.tok'
    
    
#     rouge.system_dir = '/Users/feiliu/Data/SemanticSumm/TAC_Fei/2008/peers'
#     rouge.system_filename_pattern = 'D08(\d+)-A.M.100.[A-Z].' + str(system) + '$'
...
#         rouge_output = rouge.evaluate()    
#         output_dict = rouge.output_to_dict(rouge_output)
#         print system, output_dict['rouge_2_recall']
